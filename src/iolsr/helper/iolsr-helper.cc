...
IOlsrHelper*
IOlsrHelper::Copy (void) const
{
  return new IOlsrHelper (*this);
}

void
IOlsrHelper::ExcludeInterface (Ptr<Node> node, uint32_t interface)
{
...
void
IOlsrHelper::Set (std::string name, const AttributeValue &value)
{
  m_agentFactory.Set (name, value);
}

int64_t
IOlsrHelper::AssignStreams (NodeContainer c, int64_t stream)
{
